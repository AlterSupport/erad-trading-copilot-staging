  ...
  return (
    <Card className='flex flex-col gap-5 w-full p-5'>
      <CardHeader className='flex items-center gap-3 px-0'>
        <div className='size-9 rounded-full border border-border text-foreground flex justify-center items-center bg-background'>
          <FileText size={15} />
        </div>
      ...
      <div className='max-w-4xl mx-auto flex flex-col gap-5 w-full'>
        ...
        <Card className=''>
          ...
          <CardFooter>
            <Alert className='w-full space-y-2 border border-border bg-secondary/40 dark:bg-secondary/20'>
              <Info size={15} color='#0028F0' />
              <AlertTitle className='text-sm font-medium text-secondary-badge'>
